...
const ProductDetail: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-myura-green-50">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-myura-green-400 to-myura-green-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold text-white mb-4">PRODUCT</h1>
          <p className="text-xl text-myura-green-100">Wellness you can feel, results you can see.</p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <div className="relative">
                ...
                <div className="absolute top-4 left-4 bg-myura-green-500 text-white px-3 py-1 rounded-full text-sm font-semibold">
                  Sale!
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4 mb-6">
              ...
              <button
                ...
                className="flex-1 bg-myura-green-600 text-white py-3 px-6 rounded-lg hover:bg-myura-green-700 transition-colors font-semibold"
              >
                ADD TO CART
              </button>
            </div>
                        ...
                        <ul className="space-y-2">
                          {(section.content as string[]).map((item, index) => (
                            <li key={index} className="flex items-start space-x-2">
                              <div className="w-2 h-2 bg-myura-green-600 rounded-full mt-2 flex-shrink-0"></div>
        ...
        <section className="mt-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">A Perfect Ingredient & Combination</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Nano Vitamin C</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {[1, 2].map((item) => (
              <div key={item} className="text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">WOMEN'S HEALTH PLUS</h3>
                <div className="grid grid-cols-2 gap-4 max-w-xs mx-auto">
                  <div className="text-center">
                    <div className="w-12 h-12 bg-purple-200 rounded-full mx-auto mb-2 flex items-center justify-center">
                      <Heart className="h-6 w-6 text-purple-600" />
                    </div>
                    <p className="text-sm font-semibold text-gray-900">Immunity</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-purple-200 rounded-full mx-auto mb-2 flex items-center justify-center">
                      <Heart className="h-6 w-6 text-purple-600" />
                    </div>
                    <p className="text-sm font-semibold text-gray-900">Hormonal Balance</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-purple-200 rounded-full mx-auto mb-2 flex items-center justify-center">
                      <Heart className="h-6 w-6 text-purple-600" />
                    </div>
                    <p className="text-sm font-semibold text-gray-900">Strength</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-purple-200 rounded-full mx-auto mb-2 flex items-center justify-center">
                      <Heart className="h-6 w-6 text-purple-600" />
                    </div>
                    <p className="text-sm font-semibold text-gray-900">Energy Control</p>
                  </div>
                </div>
              </div>
            ))}
            ...
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-4 mt-2">
                  ...
                  <span className="font-semibold text-gray-900">₹2,397.00</span>
                </div>
              </div>
              <button className="text-red-500 text-sm">Remove</button>
            </div>
            
            <button className="w-full bg-myura-green-600 text-white py-3 rounded-lg font-semibold hover:bg-myura-green-700 transition-colors">
              Checkout - ₹2,397.00
            </button>
          </div>
        </div>
      ...
      <div className="fixed bottom-8 right-8 z-40">
        <div className="flex flex-col items-end space-y-4">
          <div className="relative">
            <button className="w-12 h-12 bg-myura-green-600 text-white rounded-full flex items-center justify-center hover:bg-myura-green-700 transition-colors">
