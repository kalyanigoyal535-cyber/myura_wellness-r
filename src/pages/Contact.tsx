    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div>
                <p className="text-sm text-myura-green-600 font-medium italic mb-2">Get in touch</p>
                <h2 className="text-4xl font-bold text-gray-900 mb-6">We're Here For You - Always</h2>
              ...
              <div className="space-y-6">
                <div className="bg-gray-100 rounded-xl p-6">
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-myura-green-600 rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div className="bg-gray-100 rounded-xl p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">care@myurawellness.com</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 rounded-xl p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">+91 9133 001 177</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-myura-green-500 focus:border-transparent"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-myura-green-600 text-white py-3 px-6 rounded-lg hover:bg-myura-green-700 transition-colors font-semibold flex items-center justify-center"
                  >
                    Submit
              ...
              <div className="absolute -right-4 top-1/2 transform -translate-y-1/2">
                <div className="relative">
                  <button className="w-16 h-16 bg-myura-green-600 text-white rounded-full flex items-center justify-center hover:bg-myura-green-700 transition-colors shadow-lg">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="w-16 h-16 bg-myura-green-600 rounded-full flex items-center justify-center mx-auto mb-6">
            <MessageCircle className="h-8 w-8 text-white" />
          </div>
          <h2 className="text-4xl font-bold text-gray-900 mb-6">Your Wellness, Our Priority</h2>
          <p className="text-lg text-gray-700 leading-relaxed">
