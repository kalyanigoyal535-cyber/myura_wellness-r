...
const About = (props: Props) => {
  ...
  return (
    <div>
      {/* about us  */}
      <section
        className="w-full bg-[#F8F8F8] py-12 md:py-16"
        data-aos="fade-up"
      >
        <div className="max-w-6xl mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
            ...
            {/* Text Section */}
            <div
              className="col-span-12 md:col-span-6 flex flex-col justify-center text-center md:text-left"
              data-aos="fade-left"
              data-aos-delay="200"
            >
              ...
              <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                At Myura, we're building more than a brand—we're creating a
                movement for authentic, science-backed natural health. Our core
                belief is simple:{" "}
                <span className="text-[#1E2738] font-medium">
                  honesty, purity, and craftsmanship
                </span>{" "}
                are non-negotiable. We combine ancient Ayurvedic wisdom with
                modern scientific validation to deliver solutions that simply
                work.
              </p>
            </div>
          </div>
      ...
      <section className="w-full bg-[#1E2738] py-12 md:py-16" data-aos="fade-up">
        <div className="max-w-6xl mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
            {/* Left Section */}
            <div
              className="col-span-12 md:col-span-6 text-white"
              data-aos="fade-right"
              data-aos-delay="100"
            >
              ...
              <div className="w-full max-w-xl">
                <div className="relative rounded-2xl bg-[#222b3a] p-4 md:p-5 shadow-xl overflow-hidden">
                  ...
                  <p className="relative z-10 mt-3 text-[11px] md:text-xs text-gray-300 leading-relaxed">
                    Get a closer look at how Myura Men&apos;s Vitality Booster is
                    crafted and why it stands apart from typical one-size-fits-all
                    supplements.
                  </p>
                </div>
              </div>
      ...
      {/* Your Best Health section */}
      <div
        className="grid grid-cols-1 md:grid-cols-12 gap-6 md:h-[400px] md:mb-52 p-4"
        data-aos="fade-up"
      >
        {/* Image Section */}
        <div
          className="md:col-span-6 flex justify-center items-center order-1 md:order-1"
          data-aos="zoom-in"
          data-aos-delay="100"
        >
        ...
        {/* Text Section */}
        <div
          className="md:col-span-6 flex flex-col justify-center px-8 py-8 bg-[#2A3244] text-white rounded-2xl shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 order-2 md:order-2"
          data-aos="fade-left"
          data-aos-delay="200"
        >
          ...
          <p className="text-sm md:text-base text-white/80 leading-relaxed text-center md:text-left">
            Experience the synergy of ancient Ayurvedic wisdom and modern science
            with
            <span className="text-[#38BDF8] font-medium"> MYURA</span>. Wake up
            refreshed, feel balanced, and stay unstoppable all day.
            <br />
            <br />
            Our advanced botanical formulations detoxify naturally, enhance
            vitality, support hormonal balance, aid digestion, and fortify joint
            health — helping you feel lighter and more alive from within.
            <br />
            <br />
            <span className="font-medium text-white">
              No fillers. No shortcuts. Just clean, transparent ingredients
