...
const Upselling = () => {
  ...
  const upsellItems = productCatalog.slice(0, 6);

  return (
    <div className="w-full col-span-full mt-10">
      <h2 className="text-xl font-semibold mb-6 px-4">Customers Also Bought</h2>
        ...
        {upsellItems.map((item) => (
          ...
          >
            ...
            <div className="flex flex-col justify-between h-28">
              ...
              <button className="w-full bg-[#1C273A] text-white py-1.5 rounded text-sm">
                ADD
              </button>
            </div>
          </div>
