...
const PinterestIcon = FaPinterestP as React.ComponentType<{
  className?: string;
}>;
const TwitterIcon = FaTwitter as React.ComponentType<{ className?: string }>;
const LinkedinIcon = FaLinkedinIn as React.ComponentType<{
  className?: string;
}>;
...
const Footer: React.FC = React.memo(() => {
  return (
    <footer
      id="site-footer"
      className="relative bg-gradient-to-br from-stone-50 via-neutral-50 to-stone-100 text-black overflow-hidden"
    >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <p className="text-black/70 leading-relaxed text-sm font-minimal text-left tracking-wide">
                Ayurvedic wellness made simple. Myura offers honest, natural
                supplements for daily vitality, balance, and better living—no
                shortcuts, just nature.
              </p>
              ...
              <div className="flex justify-start gap-3 overflow-x-auto sm:overflow-visible">
                {[
                  {
                    Icon: FacebookIcon,
                    url: "https://www.facebook.com/myurawellness",
                    color: "from-black to-black/80",
                    hover: "hover:from-black/80 hover:to-black/60",
                  },
                  {
                    Icon: InstagramIcon,
                    url: "https://www.instagram.com/myurawellness/",
                    color: "from-black to-black/80",
                    hover: "hover:from-black/80 hover:to-black/60",
                  },
                  {
                    Icon: YoutubeIcon,
                    url: "https://www.youtube.com/@MyuraWellness",
                    color: "from-black to-black/80",
                    hover: "hover:from-black/80 hover:to-black/60",
                  },
                  {
                    Icon: PinterestIcon,
                    url: "https://www.pinterest.com/myurawellness/",
                    color: "from-black to-black/80",
                    hover: "hover:from-black/80 hover:to-black/60",
                  },
                  {
                    Icon: TwitterIcon,
                    url: "https://x.com/Myurawellness",
                    color: "from-black to-black/80",
                    hover: "hover:from-black/80 hover:to-black/60",
                  },
                  {
                    Icon: LinkedinIcon,
                    url: "https://www.linkedin.com/company/myurawellness",
                    color: "from-black to-black/80",
                    hover: "hover:from-black/80 hover:to-black/60",
                  },
                  {
                ...
                ].map(({ Icon, url, color, hover }, index) => (
                  <a
                    key={index}
                    href={url}
                    target="_blank"
              ...
              <div className="space-y-4 sm:space-y-5">
                <div className="flex items-start space-x-3 sm:space-x-4 group">
                  ...
                  <div className="min-w-0 text-left">
                    <p className="text-black/60 text-xs uppercase tracking-widest font-minimal mb-1">
                      Phone
                    </p>
                    <a
                ...
                <div className="flex items-start space-x-3 sm:space-x-4 group">
                  ...
                  <div className="min-w-0 text-left">
                    ...
                    >
                      Plot No. 15C, IT Park, Sector 22, Panchkula, Haryana,
                      134109
                    </a>
                  </div>
                </div>
          ...
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
            <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
              <div className="text-black text-sm sm:text-base text-center lg:text-left font-minimal">
                ...
                <span className="font-minimal font-semibold">
                  Myura Wellness
                </span>{" "}
                is a brand of{" "}
                <span className="font-minimal font-semibold">
                  JAC Nutrition Pvt. Ltd.
                </span>{" "}
                All rights reserved.
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-4">
                <span className="text-black text-xs sm:text-sm font-minimal">
                  We Accept:
                </span>
